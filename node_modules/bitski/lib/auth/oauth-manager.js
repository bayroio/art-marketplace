...
class OAuthManager {
    ...
    constructor(options) {
        ...
        this.configuration = options.configuration || new appauth_1.AuthorizationServiceConfiguration(constants_1.DEFAULT_OAUTH_CONFIGURATION);
    ...
    requestSignOut(accessToken) {
        return fetch(`${constants_1.BITSKI_USER_API_HOST}/logout`, {
            ...
            return request_utils_1.parseResponse(response);
        });
    }
    /**
