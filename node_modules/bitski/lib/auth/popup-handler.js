...
class PopupRequestHandler extends appauth_1.AuthorizationRequestHandler {
    ...
    completeAuthorizationRequest() {
        ...
        const data = callback_1.parseUrlParams(this.responseUrl);
        // Extra the state
    ...
    respondWithError(request, errorMessage, errorDescription, errorUri) {
        const error = new appauth_1.AuthorizationError({ error: errorMessage, error_description: errorDescription, error_uri: errorUri, state: request.state });
        const response = { request, error, response: null };
        this.cleanup();
        return Promise.resolve(response);
    }
