...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/token-store.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> token-store.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(clientId: string, store?: Store) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (accessTokenString) {
      let parsedToken: AccessToken | undefined;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        parsedToken = AccessToken.fromString(accessTokenString);</span>
      } finally {
<span class="cstat-no" title="statement not covered" >        this.accessToken = parsedToken;</span>
      }
    }
  }
&nbsp;
  public persistTokenResponse(response: TokenResponse) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (response.refreshToken) {
<span class="cstat-no" title="statement not covered" >      this.store.setItem(this.refreshTokenKey, response.refreshToken);</span>
    }
