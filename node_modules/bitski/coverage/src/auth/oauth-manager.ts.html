...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/oauth-manager.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> oauth-manager.ts
    </h1>
    <div class='clearfix'>
...
<a name='L255'></a><a href='#L255'>255</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
&nbsp;
  ...
  public requestUserInfo(accessToken: string): Promise&lt;UserInfoResponse&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!userInfoEndpoint) {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(AuthenticationError.InvalidConfiguration('Could not find user info endpoint'));</span>
    }
...
&nbsp;
  ...
  protected didCompleteAuthorizationFlow(request: AuthorizationRequest, response: AuthorizationResponse | null, errorResponse: AuthorizationError | null) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.pendingResolver) {
      if (response) {
        this.pendingResolver.fulfill(response);
        this.pendingResolver = undefined;
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (errorResponse) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (errorResponse instanceof PopupClosedError) {
<span class="cstat-no" title="statement not covered" >          this.pendingResolver.reject(AuthenticationError.UserCancelled());</span>
          ...
          const baseUrl = matches &amp;&amp; matches.length &gt; 1 ? matches[1] : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
