...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/popup-handler.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> popup-handler.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">86.14% </span>
...
<span class="cstat-no" title="statement not covered" >    super({ error: 'The popup was dismissed.'});</span>
  }
}
&nbsp;
...
function createCenteredPopupFeatures(): any {
  ...
  const windowWidth = window.innerWidth || <span class="branch-1 cbranch-no" title="branch not covered" >document.documentElement.clientWidth </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >screen.width;</span>
  const windowHeight = window.innerHeight || <span class="branch-1 cbranch-no" title="branch not covered" >document.documentElement.clientHeight </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >screen.height;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isCancelled === true) {
<span class="cstat-no" title="statement not covered" >      return this.respondWithCancelled(request);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this.respondWithError(request, this.error.message);</span>
    }
&nbsp;
    // Assert there is a response url to parse
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.responseUrl) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (request.state !== state) {
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(null);</span>
    }
&nbsp;
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >respondWithCancelled(</span>request: AuthorizationRequest): Promise&lt;AuthorizationRequestResponse&gt; {
    const error = <span class="cstat-no" title="statement not covered" >new PopupClosedError();</span>
    const response = <span class="cstat-no" title="statement not covered" >{ request, error, response: null };</span>
...
&nbsp;
  protected cleanup() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.popupWindow) {
<span class="cstat-no" title="statement not covered" >      this.popupWindow.close();</span>
    }
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >checkPopup(</span>) {
<span class="cstat-no" title="statement not covered" >    if (this.popupWindow &amp;&amp; this.popupWindow.closed) {</span>
      // Stop checking
<span class="cstat-no" title="statement not covered" >      window.clearInterval(this.closedTimer);</span>
<span class="cstat-no" title="statement not covered" >      this.isCancelled = true;</span>
<span class="cstat-no" title="statement not covered" >      this.completeAuthorizationRequestIfPossible();</span>
    }
  }
&nbsp;
}
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Oct 28 2019 15:42:40 GMT-0700 (Pacific Daylight Time)
</div>
</div>
