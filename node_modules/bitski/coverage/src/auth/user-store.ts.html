...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/user-store.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> user-store.ts
    </h1>
    <div class='clearfix'>
...
<a name='L52'></a><a href='#L52'>52</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { USER_KEY } from '../constants';
...
<span class="cstat-no" title="statement not covered" >      return User.fromString(userData);</span>
    }
  }
&nbsp;
