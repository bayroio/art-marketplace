...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/openid-auth-provider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> openid-auth-provider.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { AccessTokenProvider } from 'bitski-provider';
...
&nbsp;
    public invalidateToken(): Promise&lt;void&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.tokenStore.currentToken) {
            this.tokenStore.invalidateCurrentToken();
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.signOutCallback) {
