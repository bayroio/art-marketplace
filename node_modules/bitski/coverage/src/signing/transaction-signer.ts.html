...
<html lang="en">
<head>
    <title>Code coverage report for src/signing/transaction-signer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/signing</a> transaction-signer.ts
    </h1>
    <div class='clearfix'>
...
<a name='L140'></a><a href='#L140'>140</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">7x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Dialog } from '../components/dialog';
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.currentRequestDialog) {
