...
<html lang="en">
<head>
    <title>Code coverage report for src/providers/bitski-browser-engine.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/providers</a> bitski-browser-engine.ts
    </h1>
    <div class='clearfix'>
...
<a name='L106'></a><a href='#L106'>106</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { AccessTokenProvider, AuthenticatedFetchSubprovider, BitskiEngine, Network } from 'bitski-provider';
...
&nbsp;
  constructor(
    ...
    sdkVersion: string,
    network: Network,
    options: ProviderOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span>
  ) {
    super(options);
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (isAuthProvider(this.tokenProvider)) {
