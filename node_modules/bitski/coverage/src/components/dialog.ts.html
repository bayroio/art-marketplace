...
<html lang="en">
<head>
    <title>Code coverage report for src/components/dialog.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> dialog.ts
    </h1>
    <div class='clearfix'>
...
<a name='L164'></a><a href='#L164'>164</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const TEMPLATE = `
...
&nbsp;
  ...
  public setLoading(loading: boolean) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (body) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (loading) {
        body.classList.add('bitski-loading');
      } else {
<span class="cstat-no" title="statement not covered" >        body.classList.remove('bitski-loading');</span>
      }
    }
  }
&nbsp;
...
&nbsp;
  ...
  private addCloseHandlers() {
    ...
    this.container.addEventListener('click', (event) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (event.target === this.container) {
        this.close();
      }
    });
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (closeButton) {
