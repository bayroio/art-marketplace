...
<html lang="en">
<head>
    <title>Code coverage report for src/components/connect-button.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> connect-button.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { AuthProvider } from '../auth/auth-provider';
...
&nbsp;
   ...
   */
  public remove() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.element.parentNode) {
  ...
  private signin() {
    this.authProvider.signInOrConnect(this.authIntegrationType, this.signInOptions).then((user) =&gt; {
      ...
      if (error instanceof AuthenticationError &amp;&amp; error.code === AuthenticationErrorCode.UserCancelled) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.onCancel) {
          this.onCancel();
        }
