...
<html lang="en">
<head>
    <title>Code coverage report for src/errors/authentication-error.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/errors</a> authentication-error.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  public <span class="fstat-no" title="function not covered" >static </span>InvalidConfiguration(reason: string) {
<span class="cstat-no" title="statement not covered" >    return new AuthenticationError(`The OAuth Configuration is invalid: ${reason}`, AuthenticationErrorCode.InvalidConfiguration);</span>
  }
&nbsp;
