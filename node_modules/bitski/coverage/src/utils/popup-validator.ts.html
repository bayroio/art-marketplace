...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/popup-validator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> popup-validator.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  public check(popup: Window | null) {
    if (popup) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (/chrome/.test(navigator.userAgent.toLowerCase())) {
<span class="cstat-no" title="statement not covered" >        setTimeout(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.isPopupBlocked(popup);</span>
        }, 200);
      } else {
        popup.onload = <span class="fstat-no" title="function not covered" >() =</span>&gt; {
<span class="cstat-no" title="statement not covered" >          this.isPopupBlocked(popup);</span>
        };
      }
    } else {
...
&nbsp;
  protected <span class="fstat-no" title="function not covered" >isPopupBlocked(</span>popup: Window) {
<span class="cstat-no" title="statement not covered" >    if ((popup.innerHeight &gt; 0) === false) {</span>
<span class="cstat-no" title="statement not covered" >      this.handleBlocked();</span>
    }
  }
&nbsp;
