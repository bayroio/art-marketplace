...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/localstorage-store.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> localstorage-store.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  public <span class="fstat-no" title="function not covered" >clear(</span>) {
<span class="cstat-no" title="statement not covered" >    this.storage.clear();</span>
  }
&nbsp;
