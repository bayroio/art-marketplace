...
<html lang="en">
<head>
    <title>Code coverage report for src/bitski.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> bitski.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.03% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>98/101</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { AuthorizationServiceConfiguration } from '@openid/appauth';
...
export class Bitski {
   ...
   */
  public <span class="fstat-no" title="function not covered" >static </span>callback(): void {
<span class="cstat-no" title="statement not covered" >    processCallback();</span>
  }
&nbsp;
...
&nbsp;
  ...
  constructor(clientId: string, redirectUri?: string, additionalScopes?: string[], options?: BitskiSDKOptions) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (document &amp;&amp; document.body) {
      this.injectStyles();
    } else {
...
<span class="cstat-no" title="statement not covered" >        this.injectStyles();</span>
      });
    }
...
&nbsp;
  private createProvider(network: Network, options: ProviderOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span>: BitskiEngine {
...
&nbsp;
  ...
  private injectStyles(): void {
    ...
    const head = document.head || <span class="branch-1 cbranch-no" title="branch not covered" >document.getElementsByTagName('head')[0];</span>
