...
<html lang="en">
<head>
    <title>Code coverage report for src/subproviders/authenticated-cache.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/subproviders</a> authenticated-cache.ts
    </h1>
    <div class='clearfix'>
...
<a name='L73'></a><a href='#L73'>73</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cstat-no" title="statement not covered" >            return Promise.reject(new Error('Method not supported'));</span>
        }
    }
&nbsp;
