...
<html lang="en">
<head>
    <title>Code coverage report for src/subproviders/signature.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/subproviders</a> signature.ts
    </h1>
    <div class='clearfix'>
...
<a name='L323'></a><a href='#L323'>323</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">7x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Subprovider } from '@bitski/provider-engine';
  ...
  private async createContext(request: JSONRPCRequestPayload): Promise&lt;TransactionContext&gt; {
    switch (request.method) {
      ...
      case 'eth_signTypedData_v3':
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (request.params &amp;&amp; request.params.length &gt; 0) {
          return { from: request.params[0] };
        }
<span class="cstat-no" title="statement not covered" >        throw SignerError.MissingFrom();</span>
      default:
