...
const _88_crypto_collectible_1 = require("../assets/88-crypto-collectible");
...
spec.test('passes for valid data', (ctx) => {
    ...
    ctx.true(ctx.get('validator').validate(data, _88_crypto_collectible_1.schema88).valid);
});
spec.test('fails for valid data', (ctx) => {
    ...
    ctx.false(ctx.get('validator').validate(data, _88_crypto_collectible_1.schema88).valid);
});
