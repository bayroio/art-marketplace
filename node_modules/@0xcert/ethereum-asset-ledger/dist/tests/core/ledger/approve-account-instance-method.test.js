...
spec.test('approves account for token transfer', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const bob = ctx.get('bob');
    const ledger = ctx.get('ledger');
    const mutation = yield ledger.approveAccount('1', bob);
    yield mutation.complete();
    ctx.is((mutation.logs[0]).event, 'Approval');
    ctx.is(yield xcert.instance.methods.getApproved('1').call(), bob);
}));
exports.default = spec;
//# sourceMappingURL=approve-account-instance-method.test.js.map