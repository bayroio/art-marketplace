...
spec.test('destoy asset', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcertDestroyable;
    const ledger = ctx.get('ledger');
    const bob = ctx.get('bob');
    const coinbase = ctx.get('coinbase');
    yield xcert.instance.methods.create(bob, '1', '0x973124ffc4a03e66d6a4458e587d5d6146f71fc57f359c8d516e0b12a50ab0d9').send({ from: coinbase });
    const mutation = yield ledger.destroyAsset('1');
    yield mutation.complete();
    ctx.is((mutation.logs[0]).event, 'Transfer');
    ctx.is(yield xcert.instance.methods.balanceOf(bob).call(), '0');
}));
exports.default = spec;
//# sourceMappingURL=destroy-asset-instance-method.test.js.map