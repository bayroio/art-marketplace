...
spec.test('create a new asset', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const bob = ctx.get('bob');
    const mutation = yield ledger.createAsset({
        receiverId: bob,
        id: '1',
...
//# sourceMappingURL=create-asset-instance-method.test.js.map