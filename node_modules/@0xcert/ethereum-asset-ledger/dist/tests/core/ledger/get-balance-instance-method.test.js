...
spec.test('returns accounts balance', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const balance = yield ledger.getBalance(bob);
    ctx.is(balance, '0');
}));
spec.test('returns null balance on smart contract that does not support getBalance', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const provider = ctx.get('provider');
...
//# sourceMappingURL=get-balance-instance-method.test.js.map