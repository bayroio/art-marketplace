...
spec.test('returns asset id', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield xcert.instance.methods
        .create(coinbase, 1, '0x973124ffc4a03e66d6a4458e587d5d6146f71fc57f359c8d516e0b12a50ab0d9')
        .send({ from: coinbase });
    ctx.is(ethereum_utils_1.bigNumberify(yield ledger.getAssetIdAt(0)).eq('0x01'), true);
    ctx.is(yield ledger.getAssetIdAt(1), null);
}));
exports.default = spec;
//# sourceMappingURL=get-asset-id-at-method.test.js.map