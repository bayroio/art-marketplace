...
spec.test('returns recipes from exposed paths `name`', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
...
spec.test('returns recipes from exposed paths `event.organizer.name`', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schemas_1.defaultSchema,
    });
    const recipes = yield cert.disclose(schemas_1.defaultData, [
