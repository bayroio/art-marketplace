...
spec.test('empty array', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const values = [];
...
spec.test('array with element A', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const values = ['A'];
    const recipe = yield ctx.get('merkle').notarize(values);
    ctx.deepEqual(recipe, {
        values: [
...
spec.test('recipe for values A,B,C,D', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
...
spec.test('hasher function receives value, path and position parameters', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const values = ['A', 'B'];
    const hashings = [];
    const merkle = new __1.Merkle({
        hasher: (v, p, n) => {
            hashings.push([v, p, n]);
            return v;
        },
    });
    yield merkle.notarize(values);
...
spec.test('with prepended path', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const values = ['A'];
    const hashings = [];
    const merkle = new __1.Merkle({
        hasher: (v, p, n) => {
    ...
    yield merkle.notarize(values, ['a', 1]);
    ctx.deepEqual(hashings, [
        ['', ['a', 1, 1], 2],
        ['A', ['a', 1, 0], 0],
        ['A', ['a', 1, 0], 1],
...
spec.test('recipe with custom noncer function', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const values = ['A', 'B'];
    const merkle = new __1.Merkle({
        hasher: (v) => utils_1.sha(256, v),
        noncer: (p) => p.join('.'),
    });
    const recipe = yield merkle.notarize(values);
    ctx.deepEqual(recipe, {
        values: [
...
spec.test('noncer function receives path parameter', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const values = ['A', 'B'];
    const noncing = [];
    const merkle = new __1.Merkle({
        noncer: (p) => {
...
//# sourceMappingURL=notarize-instance-method.test.js.map